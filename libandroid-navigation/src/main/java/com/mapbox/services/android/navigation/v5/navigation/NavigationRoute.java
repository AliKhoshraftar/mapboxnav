...
public final class NavigationRoute {
  ...
  private final ShivehDirections mapboxDirections;
   ...
   * @since 0.5.0
   */
  private NavigationRoute(ShivehDirections mapboxDirections) {
  ...
  public static final class Builder {
    ...
    private final ShivehDirections.Builder directionsBuilder;

    /**
     * Private constructor for initializing the raw MapboxDirections.Builder
     */
    private Builder() {
      directionsBuilder = ShivehDirections.builder();
    }
