 ...
 */
@AutoValue
public abstract class ShivehDirections extends MapboxService<DirectionsResponse> {


    private static final Logger LOGGER = Logger.getLogger(ShivehDirections.class.getName());

    private okhttp3.Call.Factory callFactory;
    private Call<DirectionsResponse> call;
    private ShivehDirectionsService service;
    private Retrofit retrofit;

    private ShivehDirectionsService getService() {
        ...
        // Directions service
        service = retrofitBuilder.build().create(ShivehDirectionsService.class);
        return service;
    }
    ...
    /**
     * Build a new {@link ShivehDirections} object with the initial values set for
     * {@link #baseUrl()}, {@link #profile()}, {@link #user()}, and {@link #geometries()}.
     *
     * @return a {@link ShivehDirections.Builder} object for creating this object
     * @since 3.0.0
     */
    public static ShivehDirections.Builder builder() {
        return new AutoValue_ShivehDirections.Builder()
    ...
    /**
     * Returns the builder which created this instance of {@link ShivehDirections} and allows for
     * modification and building a new directions request with new information.
     *
     * @return {@link ShivehDirections.Builder} with the same variables set as this directions object
     * @since 3.0.0
     */
    public abstract ShivehDirections.Builder toBuilder();
    ...
    public abstract static class Builder {
         ...
         * @since 1.0.0
         */
        public abstract ShivehDirections.Builder user(@NonNull String user);
         ...
         * @since 1.0.0
         */
        public abstract ShivehDirections.Builder profile(@NonNull @DirectionsCriteria.ProfileCriteria String profile);
         ...
         * @since 1.0.0
         */
        public ShivehDirections.Builder origin(@NonNull Point origin) {
            this.origin = origin;
            return this;
        }
         ...
         * @since 1.0.0
         */
        public ShivehDirections.Builder destination(@NonNull Point destination) {
         ...
         * @since 3.0.0
         */
        public ShivehDirections.Builder addWaypoint(@NonNull Point waypoint) {
         ...
         * @since 1.0.0
         */
        public abstract ShivehDirections.Builder alternatives(@Nullable Boolean alternatives);
         ...
         * @since 2.0.0
         */
        public abstract ShivehDirections.Builder geometries(@DirectionsCriteria.GeometriesCriteria String geometries);
         ...
         * @since 1.0.0
         */
        public abstract ShivehDirections.Builder overview(@Nullable @DirectionsCriteria.OverviewCriteria String overview);
         ...
         * @since 1.0.0
         */
        public abstract ShivehDirections.Builder steps(@Nullable Boolean steps);
         ...
         * @since 1.0.0
         */
        public abstract ShivehDirections.Builder continueStraight(@Nullable Boolean continueStraight);
         ...
         * @since 2.2.0
         */
        public ShivehDirections.Builder language(@Nullable Locale language) {
            if (language != null) {
        ...
        abstract ShivehDirections.Builder language(@Nullable String language);
         ...
         * @since 3.0.0
         */
        public abstract ShivehDirections.Builder roundaboutExits(@Nullable Boolean roundaboutExits);
         ...
         * @since 2.1.0
         */
        public ShivehDirections.Builder annotations(@Nullable @DirectionsCriteria.AnnotationCriteria String... annotations) {
            this.annotations = annotations;
            return this;
        }

        abstract ShivehDirections.Builder annotation(@Nullable String annotation);
         ...
         * @since 2.0.0
         */
        public ShivehDirections.Builder addBearing(@Nullable @FloatRange(from = 0, to = 360) Double angle,
        ...
        abstract ShivehDirections.Builder bearing(@Nullable String bearings);
         ...
         * @since 1.0.0
         */
        public ShivehDirections.Builder radiuses(@FloatRange(from = 0) double... radiuses) {
            this.radiuses = radiuses;
            return this;
        }

        abstract ShivehDirections.Builder radius(@Nullable String radiuses);
         ...
         * @since 3.0.0
         */
        public abstract ShivehDirections.Builder exclude(@DirectionsCriteria.ExcludeCriteria String exclude);
         ...
         * @since 3.0.0
         */
        public abstract ShivehDirections.Builder voiceInstructions(@Nullable Boolean voiceInstructions);
         ...
         * @since 3.0.0
         */
        public abstract ShivehDirections.Builder bannerInstructions(@Nullable Boolean bannerInstructions);
         ...
         * @since 3.0.0
         */
        public abstract ShivehDirections.Builder voiceUnits(@Nullable @DirectionsCriteria.VoiceUnitCriteria String voiceUnits);
         ...
         * @since 1.0.0
         */
        public abstract ShivehDirections.Builder clientAppName(@NonNull String clientAppName);
         ...
         * @since 2.1.0
         */
        public abstract ShivehDirections.Builder accessToken(@NonNull String accessToken);
         ...
         * @since 2.1.0
         */
        public abstract ShivehDirections.Builder baseUrl(String baseUrl);

        abstract ShivehDirections.Builder coordinates(@NonNull String coordinates);

        abstract ShivehDirections autoBuild();

        /**
         * This uses the provided parameters set using the {@link ShivehDirections.Builder} and first checks that all
         * values are valid, formats the values as strings for easier consumption by the API, and lastly
         * creates a new {@link ShivehDirections} object with the values provided.
         *
         * @return a new instance of Mapbox Directions
         * @since 2.1.0
         */
        public ShivehDirections build() {
            if (origin != null) {
            ...
            ShivehDirections directions = autoBuild();
