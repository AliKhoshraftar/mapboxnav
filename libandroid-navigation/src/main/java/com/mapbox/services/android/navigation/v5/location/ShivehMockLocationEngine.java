...
/**
 * Created by Ali on 2018-01-08.
 */

public class ShivehMockLocationEngine extends LocationEngine {
   ...
   */
     ...
     * @since 2.2.0
     */
    public ShivehMockLocationEngine() {
     ...
     * @since 2.2.0
     */
    public ShivehMockLocationEngine(int delay, int speed, boolean noisyGps) {
        listeners = new ArrayList<>();
        this.delay = delay;
        this.speed = speed;
   ...
   */
    ...
    public void moveToLocation(Point point) {
        ...
        runnable = new ShivehMockLocationEngine.LocationUpdateRunnable();
